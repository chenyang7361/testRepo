...
public class BuildV5 extends android.os.Build {
    ...
    /** Indicates the current device is A8 */
    ...
    public static final boolean IS_CU_CUSTOMIZATION = "cu".equals(
            WLReflect.getSystemProperties("ro.carrier.tag"));
    ...
    private static boolean hasMsm8660Property() {
        String soc = WLReflect.getSystemProperties("ro.soc.tag");
    ...
    private static String getUserdataImageVersionCode(){
        ...
        String carrier = WLReflect.getSystemProperties("ro.carrier.tag", "");
        if (!"".equals(carrier)) {
            carrier = "_" + carrier;
        }
