...
import com.mivideo.mifm.download.support.DownloadUtil;
...
//                    throw new IllegalStateException(url + warnning);
    ...
    public void notifyDownloadFailure(String url, String message) {
        PluginDownloadManager.Companion.get().notifyDownloadFailure(url, message);
    }

    @Override
    public void notifyDownloadStart(String url) {
        PluginDownloadManager.Companion.get().notifyDownloadStart(url);
    }

    @Override
    public void notifyDownloadProgress(String url, int progress) {
        PluginDownloadManager.Companion.get().notifyDownloadProgress(url, progress);
    }

    @Override
    public void notifyDownloadSuccess(String url, String path) {
        PluginDownloadManager.Companion.get().notifyDownloadSuccess(url, path);
    }

    @Override
    public void notifyDownloadClear(boolean success, String url, String path) {
        PluginDownloadManager.Companion.get().notifyDownloadClear(success, url, path);
    }
}